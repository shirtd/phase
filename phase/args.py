...
# parser.add_argument('--frames', nargs=2, type=int, default=(29900,30250), help='frames to load')
...
parser.add_argument('--delta', default=0., type=float, help='distance to boundary (relative homology)')
